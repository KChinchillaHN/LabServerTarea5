...
SDL_Texture *rectangulo;
//    int wr=0,hr=0;
    rectangulo = IMG_LoadTexture(renderer,"rectangulo.png");
    SDL_QueryTexture(rectangulo, NULL, NULL, &w, &h);
    SDL_Rect rect_rectangulo;
    rect_background.x = 0;
    rect_background.y = 0;
    rect_background.w = w;
    rect_background.h = h;
    ...
    while (shutdownClient == false)
    {
        ...
        if (socketActive != 0)
        {
            ...
            if (messageFromServer != 0)
            {
                ...
                if(strcmp(buffer,"rectangulo")==0)
                background=rectangulo;
                //background = IMG_LoadTexture(renderer,"rectangulo.png");
